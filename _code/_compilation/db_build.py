...
etsPricesModule = SourceFileLoader('ets_prices', '/Users/gd/OneDrive - rff/Documents/Research/projects/ecp/wcpd_dataset/scripts/prices/ets_prices.py').load_module()
taxRatesModule = SourceFileLoader('tax_rates', '/Users/gd/OneDrive - rff/Documents/Research/projects/ecp/wcpd_dataset/scripts/prices/tax_rates.py').load_module()
etsCoverageModule = SourceFileLoader('ets_coverage', '/Users/gd/OneDrive - rff/Documents/Research/projects/ecp/wcpd_dataset/scripts/coverage/ets_coverage.py').load_module()
taxCoverageModule = SourceFileLoader('taxes_coverage', '/Users/gd/OneDrive - rff/Documents/Research/projects/ecp/wcpd_dataset/scripts/coverage/taxes_coverage.py').load_module()
...
indir_nat_sources = "/Users/gd/GitHub/WorldCarbonPricingDatabase/sources/national_jur"
indir_subnat_sources = "/Users/gd/GitHub/WorldCarbonPricingDatabase/sources/subnat_jur"

indir_exemptions_nat = "/Users/gd/OneDrive - rff/Documents/Research/projects/ecp/wcpd_dataset/source_data/design_and_prices/exemptions/price_exemptions/national"
indir_exemptions_subnat = "/Users/gd/OneDrive - rff/Documents/Research/projects/ecp/wcpd_dataset/source_data/design_and_prices/exemptions/price_exemptions/subnat"
...
ets_prices = etsPricesModule.prices_df("/Users/gd/OneDrive - rff/Documents/Research/projects/ecp/wcpd_dataset/source_data/design_and_prices/prices")
...
def ets_db_values(scheme_list, scheme_no):
    ...
    if scheme_no == "scheme_1":
        columns = {"id":"ets_scheme_id", "dummy":"ets_dummy", "price":"ets_price", 
                   "curr_code":"ets_curr_code"}
    if scheme_no == "scheme_2":
        columns = {"id":"ets_2_scheme_id", "dummy":"ets_2_dummy", "price":"ets_2_price", 
...
tax_rates = taxRatesModule.prices_df("/Users/gd/OneDrive - rff/Documents/Research/projects/ecp/wcpd_dataset/source_data/design_and_prices/prices/")
...
def tax_db_values(scheme_list, scheme_no):
    ...
    if scheme_no == "scheme_1":
        columns = {"id":"tax_scheme_id", "dummy":"tax_dummy", "rate":"tax_rate_excl_ex_clcu", 
                   "curr_code":"tax_curr_code"}
    if scheme_no == "scheme_2":
        columns = {"id":"tax_2_scheme_id", "dummy":"tax_2_dummy",  
...
all_jur.loc[all_jur.tax_dummy!=1, "tax_dummy"] = 0
all_jur.loc[all_jur.ets_dummy!=1, "ets_dummy"] = 0
...
all_jur.loc[all_jur.tax_dummy!=1, "tax_ex_rate"] = "NA"
...
tax_cols = ['tax_scheme_id', 'tax_rate_excl_ex_clcu', 'tax_curr_code',
            'tax_ex_rate', 'tax_rate_incl_ex_clcu']

ets_1_cols = ['ets_scheme_id', 'ets_price', 'ets_curr_code']
ets_2_cols = ['ets_2_scheme_id']#, 'ets_2_price', 'ets_curr_code']

all_jur.loc[all_jur.tax_dummy==0.0, tax_cols] = "NA" 
all_jur.loc[all_jur.ets_dummy==0.0, ets_1_cols] = "NA"

# Re-ordering columns
all_jur = all_jur[["Jurisdiction", "Year", "IPCC_cat_code", #"IEA_CODE", 
                   "Product", "tax_dummy", "ets_dummy", "tax_scheme_id",
                   "tax_rate_excl_ex_clcu", "tax_ex_rate", 
                   "tax_rate_incl_ex_clcu", "tax_curr_code", "ets_scheme_id", "ets_price",
                   "ets_curr_code"]]

all_jur_sources = all_jur_sources[["Jurisdiction", "Year", "IPCC_cat_code", 
                                   "Product", "tax_dummy", "ets_dummy", 
                                   "tax_rate_excl_ex_clcu", "tax_ex_rate",
                                   "ets_price"]]
...
for jur in countries_dic:
    all_jur_sources.loc[all_jur_sources.Jurisdiction==jur, :].to_csv("/Users/gd/Desktop/wcpd_temp/sources/nat_jur/CP_"+countries_dic[jur]+".csv", index=None)
for jur in subnat_dic:
    all_jur_sources.loc[all_jur_sources.Jurisdiction==jur, :].to_csv("/Users/gd/Desktop/wcpd_temp/sources/subnat_jur/CP_"+subnat_dic[jur]+".csv", index=None)

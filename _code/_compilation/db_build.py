...
gen_func = SourceFileLoader('general', '/Users/Users/ejoiner/OneDrive - RFF/Documents/WCPD/ECP/_code/compilation/_dependencies/dep_ecp/ecp_v3_gen_func.py').load_module()
...
stream = open("/Users/ejoiner/OneDrive - RFF/Documents/WCPD/WorldCarbonPricingDatabase/_raw/priceRebates/tax/_price_exemptions_tax_"+gas+".py")
read_file = stream.read()
exec(read_file)
...
stream = open("/Users/ejoiner/OneDrive - RFF/Documents/WCPD/WorldCarbonPricingDatabase/_code/_compilation/_preprocessing/_coverageFactors.py")
read_file = stream.read()
exec(read_file)

#------------------------------Overlap files-------------------

stream = open("/Users/ejoiner/OneDrive - RFF/Documents/WCPD/WorldCarbonPricingDatabase/_code/_compilation/_preprocessing/_overlap.py")
read_file = stream.read()
exec(read_file)
...
for jur in countries_dic:
    wcpd_all_jur.loc[wcpd_all_jur.jurisdiction==jur, :].to_csv("/Users/gd/GitHub/WorldCarbonPricingDatabase/_dataset/data/"+gas+"/national/CP_"+countries_dic[jur]+".csv", index=None)
for jur in subnat_dic:
    wcpd_all_jur.loc[wcpd_all_jur.jurisdiction==jur, :].to_csv("/Users/gd/GitHub/WorldCarbonPricingDatabase/_dataset/data/"+gas+"/subnational/CP_"+subnat_dic[jur]+".csv", index=None)

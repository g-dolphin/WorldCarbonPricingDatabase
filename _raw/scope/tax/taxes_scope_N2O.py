...
def scope():     
    ...
    can_bc_tax_scope_sources.update({2024:"leg(BC-CTA[2008]), gvt(BCGOV[2024]), gvt(BCGOV[2025])"})
    ...
    can_tax_I_scope_sources = {year: "gvt(ECCC[2019])" for year in range(2019, 2025)}
    ...
    ## scope dictionaries
    mex_dur_tax_jur_scope = {year: mex_dur_tax_jur_I for year in range(2022, 2025)}
    
    mex_dur_tax_ipcc_scope = {year: mex_dur_tax_ipcc_I for year in range(2022, 2025)}  

    mex_dur_tax_fuel_scope = {year: mex_dur_tax_fuel_I for year in range(2022, 2025)}
   ...
   #----------------------------------------------------------------------------
    ...
    ## scope dictionaries
    nld_tax_I_jur_scope = {year:nld_tax_jur_I for year in range(2021,2025)} 
    
    nld_tax_I_ipcc_scope = {year:nld_tax_ipcc_I for year in range(2021,2025)}   

    nld_tax_I_fuel_scope = {year:nld_tax_fuel_I for year in range(2021,2025)}
    
    ## Sources dictionary
    
    nld_tax_I_scope_sources = {2021:"db(WBCPD[2022])", 2022:"db(WBCPD[2023])",
    ...
    ## scope dictionaries
    nld_tax_II_jur_scope = {year:nld_tax_II_jur_I for year in range(2022, 2025)}    
    
    nld_tax_II_ipcc_scope = {year:nld_tax_II_ipcc_I for year in range(2022, 2025)}    

    nld_tax_II_fuel_scope = {year:nld_tax_II_fuel_I for year in range(2022, 2025)}
    
    ## Sources dictionary
    
    nld_tax_II_scope_sources = {2022:"leg(NLD(2020)), leg(NLD(2022))", 2023:"leg(NLD(2020)), leg(NLD(2022))",
                                2024: "leg(NLD(2020)), leg(NLD(2022))"}
    ...
    taxes_scope = {"can_bc_tax":{"jurisdictions": can_bc_tax_jur_scope,
                   ...
                   "mex_za_tax":{"jurisdictions":mex_za_tax_jur_scope, 
                    ...
                    "nld_tax_I":{"jurisdictions":nld_tax_I_jur_scope,
                                 "sectors": nld_tax_I_ipcc_scope,
                                 "fuels": nld_tax_I_fuel_scope},
    ...
    taxes_scope_sources = {"can_bc_tax":can_bc_tax_scope_sources, 
                            ...
                            "nld_tax_I":nld_tax_I_scope_sources, 
